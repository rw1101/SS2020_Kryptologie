...
<head>
    <title>Krypto2020: Video: &quot;Lecture 14: The Generalized Discrete Log Problem and the Security of Diffie-Hellman&quot;</title>
    <link rel="icon" href="//lernen.h-da.de/pluginfile.php/1/theme_adaptable/favicon/1593743412/moodle.png" />

<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="moodle, Krypto2020: Video: &quot;Lecture 14: The Generalized Discrete Log Problem and the Security of Diffie-Hellman&quot;" />
...
M.cfg = {"wwwroot":"https:\/\/lernen.h-da.de","sesskey":"2OOunWPYPj","themerev":"1593743412","slasharguments":1,"theme":"adaptable","iconsystemmodule":"core\/icon_system_standard","jsrev":"1593743413","admin":"admin","svgicons":true,"usertimezone":"Europa\/Berlin","contextid":498733};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
<script type="text/javascript" async src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.1/MathJax.js?config=TeX-MML-AM_CHTML"> </script>    <!-- CSS print media -->
    ...
    <meta name="twitter:title" value="Krypto2020: Video: &quot;Lecture 14: The Generalized Discrete Log Problem and the Security of Diffie-Hellman&quot;" />

    <!-- Open Graph data -->
    <meta property="og:title" content="Krypto2020: Video: &quot;Lecture 14: The Generalized Discrete Log Problem and the Security of Diffie-Hellman&quot;" />
...
<body  id="page-mod-url-view" class="format-weeks  path-mod path-mod-url gecko dir-ltr lang-de yui-skin-sam yui3-skin-sam lernen-h-da-de pagelayout-incourse course-10694 context-498733 cmid-386135 category-1030 two-column nozoom has-region-side-post used-region-side-post has-region-course-section-a empty-region-course-section-a side-post-only">
...
<div class="pull-right popover-region collapsed">
    <a id="message-drawer-toggle-5f009b52604975f009b525ba5d4" class="nav-link d-inline-block popover-region-toggle position-relative" href="#"
            role="button">
    ...
    <div class="popover-region-toggle nav-link"
        ...
        role="button"
        aria-controls="popover-region-container-5f009b52618415f009b525ba5d5"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-5f009b52618415f009b525ba5d5"
...
<div class="container outercont">
    <div id="page-content" class="row-fluid">
        <div id="page-navbar" class="span12"><ul class="breadcrumb"><li><a href="https://lernen.h-da.de/"><i title="Home" class="fa fa-home fa-lg"></i></a></li><span class="separator"><i class="fa-angle-right fa"></i>
                             ...
                             </span><li><span tabindex="0">5. Juni - 18. Juni</span></li><span class="separator"><i class="fa-angle-right fa"></i>
                             </span><li><a href="https://lernen.h-da.de/mod/url/view.php?id=386135" id="action_link5f009b525ba5d6" class="" >Video: "Lecture 14: The Generalized Discrete Log Problem and the Security of Diffie-Hellman"</a></li></ul></div>
        <section id="region-main" class="span9 desktop-first-column">
            <span class="notifications" id="user-notifications"></span><div role="main"><span id="maincontent"></span><h2>Video: "Lecture 14: The Generalized Discrete Log Problem and the Security of Diffie-Hellman"</h2><div class="urlworkaround">Klicken Sie auf '<a href="https://www.youtube.com/watch?v=IGqrbM52wtg" onclick="this.target='_blank';">https://www.youtube.com/watch?v=IGqrbM52wtg</a>', um die Ressource zu öffnen</div></div>        </section>

        <aside id="block-region-side-post" class="span3 block-region" data-blockregion="side-post" data-droptarget="1"><a class="skip skip-block" id="fsb-1" href="#sb-1">Einstellungen überspringen</a><div id="inst5" class="block_settings block" role="navigation" data-block="settings" data-instanceid="5" aria-labelledby="instance-5-header"><div class="header"><div class="title"><div class="block_action"></div><h2 id="instance-5-header">Einstellungen</h2></div></div><div class="content"><div id="settingsnav" class="box block_tree_box"><ul class="block_tree list" role="tree" data-ajax-loader="block_navigation/site_admin_loader"><li class="type_course depth_1 contains_branch" tabindex="-1" aria-labelledby="label_1_1"><p class="tree_item root_node tree_item branch" role="treeitem" aria-expanded="false" aria-owns="random5f009b525ba5d1_group"><span tabindex="0">Kurs-Administration</span></p><ul id="random5f009b525ba5d1_group" role="group" aria-hidden="true"><li class="type_setting depth_2 item_with_icon" tabindex="-1" aria-labelledby="label_2_1"><p class="tree_item hasicon tree_item leaf" role="treeitem"><a href="https://lernen.h-da.de/enrol/self/unenrolself.php?enrolid=23859"><img class="icon navicon" alt="" aria-hidden="true" src="https://lernen.h-da.de/theme/image.php/adaptable/core/1593743412/i/user" />Ausschreiben aus 'Krypto2020'</a></p></li></ul></li></ul></div></div></div><span class="skip-block-to" id="sb-1"></span></aside>    </div>
</div>

<div
    id="message-drawer-5f009b526772e5f009b525ba5d8"
...
>
    <div class="drawer-top border-bottom bg-secondary text-right">
        <div class="p-2">
            <a id="message-drawer-close-5f009b526772e5f009b525ba5d8" href="#">
    ...
    <div class="body-container position-relative" data-region="body-container">
        ...
        >
                ...
                <div class="p-3 border-bottom">
                    <ul class="nav nav-pills d-flex m-0" role="tablist">
                        <li class="nav-item w-50 align-self-stretch text-center active">
                            <a
                                id="contacts-tab-5f009b526772e5f009b525ba5d8"
                                class="nav-link"
                                href="#contacts-tab-panel-5f009b526772e5f009b525ba5d8"
                                data-toggle="tab"
                                data-action="show-contacts-section"
                                role="tab"
                                aria-controls="contacts-tab-panel-5f009b526772e5f009b525ba5d8"
                                aria-selected="true"
                            >
                                Kontakte
                            </a>
                        ...
                        <li class="nav-item w-50 text-center">
                            <a
                                id="requests-tab-5f009b526772e5f009b525ba5d8"
                                class="nav-link"
                                href="#requests-tab-panel-5f009b526772e5f009b525ba5d8"
                                data-toggle="tab"
                                data-action="show-requests-section"
                                role="tab"
                                aria-controls="requests-tab-panel-5f009b526772e5f009b525ba5d8"
                                aria-selected="false"
                            >
                                Anfragen
                                <span class="badge bg-primary ml-2 hidden"
            ...
            data-user-id="54768"
                                id="contacts-tab-panel-5f009b526772e5f009b525ba5d8"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-5f009b526772e5f009b525ba5d8"
        ...
        >
            ...
            data-region="lazy-load-list"
            data-user-id="54768"
                                id="requests-tab-panel-5f009b526772e5f009b525ba5d8"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-5f009b526772e5f009b525ba5d8"
            ...
            <div class="hidden" data-region="content-container">
                ...
                <div data-region="settings" class="p-3">
                    ...
                    <div data-preference="blocknoncontacts" class="mb-3">
                            <div class="custom-control custom-radio mb-2">
                                <input
                                    ...
                                    id="block-noncontacts-5f009b526772e5f009b525ba5d8-1"
                                    value="1"
                                >
                                <label class="custom-control-label ml-2" for="block-noncontacts-5f009b526772e5f009b525ba5d8-1">
                                    Nur meine Kontakte
                                </label>
                            </div>
                            <div class="custom-control custom-radio mb-2">
                                <input
                                    ...
                                    name="message_blocknoncontacts"
                                    class="custom-control-input"
                                    id="block-noncontacts-5f009b526772e5f009b525ba5d8-0"
                                    value="0"
                                >
                                <label class="custom-control-label ml-2" for="block-noncontacts-5f009b526772e5f009b525ba5d8-0">
                    ...
                    <div data-preference="entertosend">
                        <span class="switch">
                            <input type="checkbox"
                                id="enter-to-send-5f009b526772e5f009b525ba5d8"
                                
                            >
                            <label for="enter-to-send-5f009b526772e5f009b525ba5d8">
...
function legacy_activity_onclick_handler_1(e) { e.halt(); window.open('https://lernen.h-da.de/mod/url/view.php?id=386131&redirect=1'); return false; };
function legacy_activity_onclick_handler_2(e) { e.halt(); window.open('https://lernen.h-da.de/mod/url/view.php?id=386133&redirect=1'); return false; };
function legacy_activity_onclick_handler_3(e) { e.halt(); window.open('https://lernen.h-da.de/mod/url/view.php?id=386135&redirect=1'); return false; };
...
function(
    ...
    var toggle = $('#message-drawer-toggle-5f009b52604975f009b525ba5d4');
    Popover.init(toggle);
});
;
...
;
    ...
    require(['core/yui'], function(Y) {
            Y.on('click', legacy_activity_onclick_handler_3, '#action_link5f009b525ba5d6', null);
    });
;
...
function(
    ...
    var root = $('#message-drawer-5f009b526772e5f009b525ba5d8');
    ...
    var toggle = $('#message-drawer-close-5f009b526772e5f009b525ba5d8');
    Popover.init(toggle);
});
;
...
M.util.init_block_hider(Y, {"id":"inst5","title":"Einstellungen","preference":"block5hidden","tooltipVisible":"Block Einstellungen verbergen","tooltipHidden":"Block Einstellungen anzeigen"});
 M.util.js_pending('random5f009b525ba5d9'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random5f009b525ba5d9'); });
})();
//]]>
</script>
