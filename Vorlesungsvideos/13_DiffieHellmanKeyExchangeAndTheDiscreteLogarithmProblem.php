...
<head>
    <title>Krypto2020: Video &quot;Lecture 13: Diffie-Hellman Key Exchange and the Discrete Log Problem&quot;</title>
    <link rel="icon" href="//lernen.h-da.de/pluginfile.php/1/theme_adaptable/favicon/1593743412/moodle.png" />

<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="moodle, Krypto2020: Video &quot;Lecture 13: Diffie-Hellman Key Exchange and the Discrete Log Problem&quot;" />
...
M.cfg = {"wwwroot":"https:\/\/lernen.h-da.de","sesskey":"2OOunWPYPj","themerev":"1593743412","slasharguments":1,"theme":"adaptable","iconsystemmodule":"core\/icon_system_standard","jsrev":"1593743413","admin":"admin","svgicons":true,"usertimezone":"Europa\/Berlin","contextid":498731};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
<script type="text/javascript" async src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.1/MathJax.js?config=TeX-MML-AM_CHTML"> </script>    <!-- CSS print media -->
    ...
    <meta name="twitter:title" value="Krypto2020: Video &quot;Lecture 13: Diffie-Hellman Key Exchange and the Discrete Log Problem&quot;" />

    <!-- Open Graph data -->
    <meta property="og:title" content="Krypto2020: Video &quot;Lecture 13: Diffie-Hellman Key Exchange and the Discrete Log Problem&quot;" />
...
<body  id="page-mod-url-view" class="format-weeks  path-mod path-mod-url gecko dir-ltr lang-de yui-skin-sam yui3-skin-sam lernen-h-da-de pagelayout-incourse course-10694 context-498731 cmid-386133 category-1030 two-column nozoom has-region-side-post used-region-side-post has-region-course-section-a empty-region-course-section-a side-post-only">
...
<div class="pull-right popover-region collapsed">
    <a id="message-drawer-toggle-5f009b3b2ddb85f009b3b2a4484" class="nav-link d-inline-block popover-region-toggle position-relative" href="#"
            role="button">
    ...
    <div class="popover-region-toggle nav-link"
        ...
        role="button"
        aria-controls="popover-region-container-5f009b3b2ec065f009b3b2a4485"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-5f009b3b2ec065f009b3b2a4485"
...
>
    <div class="drawer-top border-bottom bg-secondary text-right">
        <div class="p-2">
            <a id="message-drawer-close-5f009b3b331cf5f009b3b2a4488" href="#">
    ...
    <div class="body-container position-relative" data-region="body-container">
        ...
        >
                ...
                <div class="p-3 border-bottom">
                    <ul class="nav nav-pills d-flex m-0" role="tablist">
                        <li class="nav-item w-50 align-self-stretch text-center active">
                            <a
                                id="contacts-tab-5f009b3b331cf5f009b3b2a4488"
                                class="nav-link"
                                href="#contacts-tab-panel-5f009b3b331cf5f009b3b2a4488"
                                data-toggle="tab"
                                data-action="show-contacts-section"
                                role="tab"
                                aria-controls="contacts-tab-panel-5f009b3b331cf5f009b3b2a4488"
                                aria-selected="true"
                            >
                                Kontakte
                            </a>
                        ...
                        <li class="nav-item w-50 text-center">
                            <a
                                id="requests-tab-5f009b3b331cf5f009b3b2a4488"
                                class="nav-link"
                                href="#requests-tab-panel-5f009b3b331cf5f009b3b2a4488"
                                data-toggle="tab"
                                data-action="show-requests-section"
                                role="tab"
                                aria-controls="requests-tab-panel-5f009b3b331cf5f009b3b2a4488"
                                aria-selected="false"
                            >
                                Anfragen
                                <span class="badge bg-primary ml-2 hidden"
            ...
            data-user-id="54768"
                                id="contacts-tab-panel-5f009b3b331cf5f009b3b2a4488"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-5f009b3b331cf5f009b3b2a4488"
        ...
        >
            ...
            data-region="lazy-load-list"
            data-user-id="54768"
                                id="requests-tab-panel-5f009b3b331cf5f009b3b2a4488"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-5f009b3b331cf5f009b3b2a4488"
            ...
            <div class="hidden" data-region="content-container">
                ...
                <div data-region="settings" class="p-3">
                    ...
                    <div data-preference="blocknoncontacts" class="mb-3">
                            <div class="custom-control custom-radio mb-2">
                                <input
                                    ...
                                    id="block-noncontacts-5f009b3b331cf5f009b3b2a4488-1"
                                    value="1"
                                >
                                <label class="custom-control-label ml-2" for="block-noncontacts-5f009b3b331cf5f009b3b2a4488-1">
                                    Nur meine Kontakte
                                </label>
                            </div>
                            <div class="custom-control custom-radio mb-2">
                                <input
                                    ...
                                    name="message_blocknoncontacts"
                                    class="custom-control-input"
                                    id="block-noncontacts-5f009b3b331cf5f009b3b2a4488-0"
                                    value="0"
                                >
                                <label class="custom-control-label ml-2" for="block-noncontacts-5f009b3b331cf5f009b3b2a4488-0">
                    ...
                    <div data-preference="entertosend">
                        <span class="switch">
                            <input type="checkbox"
                                id="enter-to-send-5f009b3b331cf5f009b3b2a4488"
                                
                            >
                            <label for="enter-to-send-5f009b3b331cf5f009b3b2a4488">
...
function(
    ...
    var toggle = $('#message-drawer-toggle-5f009b3b2ddb85f009b3b2a4484');
    Popover.init(toggle);
});
;
...
;
    ...
    require(['core/yui'], function(Y) {
            Y.on('click', legacy_activity_onclick_handler_2, '#action_link5f009b3b2a4486', null);
    });
;
...
function(
    ...
    var root = $('#message-drawer-5f009b3b331cf5f009b3b2a4488');
    ...
    var toggle = $('#message-drawer-close-5f009b3b331cf5f009b3b2a4488');
    Popover.init(toggle);
});
;
...
M.util.init_block_hider(Y, {"id":"inst5","title":"Einstellungen","preference":"block5hidden","tooltipVisible":"Block Einstellungen verbergen","tooltipHidden":"Block Einstellungen anzeigen"});
 M.util.js_pending('random5f009b3b2a4489'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random5f009b3b2a4489'); });
})();
//]]>
</script>
