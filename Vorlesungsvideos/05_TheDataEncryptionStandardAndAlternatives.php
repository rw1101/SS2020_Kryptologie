...
<div class="pull-right popover-region collapsed">
    <a id="message-drawer-toggle-5f009a94821e55f009a947d6e94" class="nav-link d-inline-block popover-region-toggle position-relative" href="#"
            role="button">
    ...
    <div class="popover-region-toggle nav-link"
        ...
        role="button"
        aria-controls="popover-region-container-5f009a94831015f009a947d6e95"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-5f009a94831015f009a947d6e95"
...
<div class="container outercont">
    <div id="page-content" class="row-fluid">
        <div id="page-navbar" class="span12"><ul class="breadcrumb"><li><a href="https://lernen.h-da.de/"><i title="Home" class="fa fa-home fa-lg"></i></a></li><span class="separator"><i class="fa-angle-right fa"></i>
                             ...
                             </span><li><a href="https://lernen.h-da.de/mod/url/view.php?id=366258" id="action_link5f009a947d6e96" class="" >Video "Lecture 5: Data Encryption Standard (DES): Encryption"</a></li></ul></div>
...
>
    <div class="drawer-top border-bottom bg-secondary text-right">
        <div class="p-2">
            <a id="message-drawer-close-5f009a948bb255f009a947d6e98" href="#">
    ...
    <div class="body-container position-relative" data-region="body-container">
        ...
        >
                ...
                <div class="p-3 border-bottom">
                    <ul class="nav nav-pills d-flex m-0" role="tablist">
                        <li class="nav-item w-50 align-self-stretch text-center active">
                            <a
                                id="contacts-tab-5f009a948bb255f009a947d6e98"
                                class="nav-link"
                                href="#contacts-tab-panel-5f009a948bb255f009a947d6e98"
                                data-toggle="tab"
                                data-action="show-contacts-section"
                                role="tab"
                                aria-controls="contacts-tab-panel-5f009a948bb255f009a947d6e98"
                                aria-selected="true"
                            >
                                Kontakte
                            </a>
                        ...
                        <li class="nav-item w-50 text-center">
                            <a
                                id="requests-tab-5f009a948bb255f009a947d6e98"
                                class="nav-link"
                                href="#requests-tab-panel-5f009a948bb255f009a947d6e98"
                                data-toggle="tab"
                                data-action="show-requests-section"
                                role="tab"
                                aria-controls="requests-tab-panel-5f009a948bb255f009a947d6e98"
                                aria-selected="false"
                            >
                                Anfragen
                                <span class="badge bg-primary ml-2 hidden"
            ...
            data-user-id="54768"
                                id="contacts-tab-panel-5f009a948bb255f009a947d6e98"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-5f009a948bb255f009a947d6e98"
        ...
        >
            ...
            data-region="lazy-load-list"
            data-user-id="54768"
                                id="requests-tab-panel-5f009a948bb255f009a947d6e98"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-5f009a948bb255f009a947d6e98"
            ...
            <div class="hidden" data-region="content-container">
                ...
                <div data-region="settings" class="p-3">
                    ...
                    <div data-preference="blocknoncontacts" class="mb-3">
                            <div class="custom-control custom-radio mb-2">
                                <input
                                    ...
                                    id="block-noncontacts-5f009a948bb255f009a947d6e98-1"
                                    value="1"
                                >
                                <label class="custom-control-label ml-2" for="block-noncontacts-5f009a948bb255f009a947d6e98-1">
                                    Nur meine Kontakte
                                </label>
                            </div>
                            <div class="custom-control custom-radio mb-2">
                                <input
                                    ...
                                    name="message_blocknoncontacts"
                                    class="custom-control-input"
                                    id="block-noncontacts-5f009a948bb255f009a947d6e98-0"
                                    value="0"
                                >
                                <label class="custom-control-label ml-2" for="block-noncontacts-5f009a948bb255f009a947d6e98-0">
                    ...
                    <div data-preference="entertosend">
                        <span class="switch">
                            <input type="checkbox"
                                id="enter-to-send-5f009a948bb255f009a947d6e98"
                                
                            >
                            <label for="enter-to-send-5f009a948bb255f009a947d6e98">
...
function(
    ...
    var toggle = $('#message-drawer-toggle-5f009a94821e55f009a947d6e94');
    Popover.init(toggle);
});
;
...
;
    ...
    require(['core/yui'], function(Y) {
            Y.on('click', legacy_activity_onclick_handler_2, '#action_link5f009a947d6e96', null);
    });
;
...
function(
    ...
    var root = $('#message-drawer-5f009a948bb255f009a947d6e98');
    ...
    var toggle = $('#message-drawer-close-5f009a948bb255f009a947d6e98');
    Popover.init(toggle);
});
;
...
M.util.init_block_hider(Y, {"id":"inst5","title":"Einstellungen","preference":"block5hidden","tooltipVisible":"Block Einstellungen verbergen","tooltipHidden":"Block Einstellungen anzeigen"});
 M.util.js_pending('random5f009a947d6e99'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random5f009a947d6e99'); });
})();
//]]>
</script>
